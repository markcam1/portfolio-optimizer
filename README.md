...
| AI | Ollama (local LLM, user-installed) |
...
│       ├── ai/        # AiAnalysis.tsx (streaming display), stream.ts (SSE reader)
...
- AI analysis is generated by Ollama running locally on your machine — no portfolio data is sent to any external server.
...
- [x] Phase 3 — Local AI analysis via Ollama (streaming commentary, persisted with run, included in PDF)
- [ ] Phase 4 — Efficient frontier chart, multiple solver support
- [ ] Phase 5 — Black-Litterman views, factor model support
- [ ] Phase 6 — Multi-source data (Alpha Vantage, Quandl, manual CSV price upload)
